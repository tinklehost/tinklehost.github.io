function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Ultimate Car Driving.loader.js";
		var config = {
        dataUrl: buildUrl + "/Ultimate Car Driving.data",
        frameworkUrl: buildUrl + "/Ultimate Car Driving.framework.js",
        codeUrl: buildUrl + "/Ultimate Car Driving.wasm",
